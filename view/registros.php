        ...
        <div class="formulario-registro-main" id="formulario">
            ...
            <div class="contenedor-formularios">
                ...
                <div class="formulario-registro ocultarDiv" id="registroUsuario">
                    <form action="../model/ProcesarUsuario.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="formulario-registro ocultarDiv" id="registroNegocio">
                    ...
                    <form action="../model/ProcesarNegocio.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="formulario_grupo" id="grupo_nombre">
                            ...
                            <p class="formulario_input-error">El nombre del establecimiento tiene que ser de 4 a 16
                                dígitos
                                y
                                solo puede contener letras.</p>
                        </div>
