...
<Body>
        <div class="main">
            ...
            <h1 class= "text-center p-3"> ADMINISTRACION NEGOCIOS</h1> <!-- Titulo visto en la pagina-->
                    ...
                    <table class="table">    <!-- Fila de titulos-->
                        ...
                        <tbody>
                            ...
                            <tr>   <!-- Fila de datos de la persona-->
                                ...
                                <td class="modificar">
                                    <a href="../model/actualizarNegocio.php?id=<?= $negocio['idNegocio']; ?>" class="btn btn-small btn-success"><i class="bi bi-pencil-square">Editar</i></a>
                                    <!--Boton editar-->
