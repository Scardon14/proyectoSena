                ...
                <nav>
                    <ul>
                        ...
                        if ($usuario['idPerfil'] === '3' || $usuario['idPerfil'] === 3) { ?>
                            ...
                            <li><a
                                    href="../model/ProcesarFotoPerfil.php?idPerfil=<?= $usuario['idPerfil']; ?>&idUsuario=<?= $usuario['idUsuario']; ?>">Mi
                                    perfil</a></li>
                            <!--<li><a href="../view/historial_citas_usuario.php">Historial</a></li>-->
                            <li><a
                                    href="../model/ProcesarReservaCliente.php?idCliente=<?= $usuario['idCliente']; ?>">Reservas</a>
                            </li>
                            ...
                            <?php
                                    ...
                                    <li><a
                                            href="../model/ProcesarFotoPerfil.php?idPerfil=<?= $usuario['idPerfil']; ?>&idUsuario=<?= $usuario['idUsuario']; ?>&idNegocio=<?= $usuario['idNegocio']; ?>">Mi
                                            barberia</a></li>
                                    <li><a
                                            href="../model/ProcesarReservaBarbero.php?idNegocio=<?= $usuario['idNegocio']; ?>&idCliente=<?= $usuario['idEmpleado']; ?>">Mi
                                            personal</a></li>
                                    <li><a href="../model/procesarInicioSesion.php">Cerrar Sesión</a></li>
                        <?php 
