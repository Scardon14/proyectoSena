...
<Body>
    <div class="main">
        ...
        <h1 class="text-center p-3"> ADMINISTRACION CLIENTES</h1> <!-- Titulo visto en la pagina-->
                            ...
                            <tr> <!-- Fila de datos de la persona-->
                                ...
                                <td class="modificar">
                                    <a href="../model/actualizarCliente.php?id=<?= $cliente['idCliente']; ?>"
                                        class="btn btn-small btn-success"><i class="bi bi-pencil-square">Editar</i></a> <!--Boton editar-->
